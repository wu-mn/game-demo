export let BodyStatic = 1;
export let BodyDynamic = 2;
export let ShapeCircle = 3;
export let ShapeRectangle = 4;
export let ShapeLine = 5;
...
// 矩形オブジェクト
export function RectangleEntity(x, y, width, height) {
...
// 線オブジェクト
export function LineEntity(x0, y0, x1, y1, restitution) {
...
// 円オブジェクト
export function CircleEntity(x, y, radius, type, restitution, deceleration) {
...
// 物理エンジン
export function Engine(x, y, width, height, gravityX, gravityY) {
  this.worldX = x || 0;
  this.worldY = y || 0;
